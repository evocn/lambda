...
There are supplemental rules attached as well, for the particular setting which I present to you.

***Notes on the rules*** |
There are some peculiar aspects of the rules which you might want to note.

* The system has no explicit progression built in to it. Instead, progression is made clear through the world and the choices a character makes.
...
I like to run a game with music. Characters have individual themes, etc.

I tend to keep the dice off the table in most scenarios.
If you come up with a plan that seems very likely, I tend to not require dice.

I work with a negotiation system. Nothing has defined modifiers, but when you make a check, 
...
I want magic to be rare and mysterious. I want there to be unknown ruins in the untrodden wilderness with untold secrets.
...
I want characters to act in a reasonable and personal way to them, and in a way that a character of this world might.

I have no reservations about the gruesome, the grim, or the (g)dark.
