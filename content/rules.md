...
How much or how little you want to take from this is up to the Dungeon Master.
...
***Violent*** |
Advantage on intimidation, immune to fear.

***Rage | 1 SP | Quick*** | 
You begin three turns of +15' movement, resistance to damage, and extra damage equal to STR/2.

##### ***Duelist*** | A swift and sharp student of the blade.
***Dual Wielding*** |
Once per turn as a quick action, you may attack with an offhand weapon.

***Riposte*** |
When an enemy attacks you, you gain advantage on attacks against them until their next turn.

***Again! | 1 SP | Quick*** |
Act a second time on this turn.
...
***Clear Body*** |
When not wearing armor, your AC gains a bonus equal to WIS/2.

***Swift*** |
+10 MOV. Advantage on acrobatics.
...
***Lay on Hands | 1 SP*** |
Heal a creature you can touch for 1d6+CHA.
...
***Nimble*** |
+10 MOV. Advantage to climb.

***Glib*** |
Advantage to manipulate creatures.

***Trickster*** |
You can perfectly impersonate peoples' behavior.

***Tracker*** |
You can follow a creature without fail, and gain advantage to tracking.

***Lucky*** |
Take half damage against traps and Area of Effect abilities.

***Assassinate*** |
Deal +3d6 to unaware targets outside of combat.

***Dodge | 1 SP | Quick*** | 
Halve incoming attack damage. Use 2 SP to nullify all damage.

***Hide  | 1 SP | Quick*** | 
Disappear. Unless you're in a very open setting, you evade all peoples' notice around you.
...
You can see through its eyes, communicate with it, and order it to do small tasks. It has 3 HP.
Reviving a familiar requires a day of rituals and suitable materials.
...
***Animal Messenger*** |
Send a creature with a short message to a person you know.
...
***Detect   | 1 SP*** |
Determine the magical properties of an object you can see.

***Dispel   | 1 SP*** |
Try to remove the magical properties of an item or creature.

***Enchant  | 1 SP*** |
For 1 hour, armor gains +2 AC and resistance to a damage type, or a weapon gains +2 damage and an elemental damage type.
...
***Water Breathing | 1 SP*** |
You and 10 creatures may breathe water for 1 hour.
...
***Cure*** | 
Try to cure a creature's afflictions and illnesses.

***Calm*** | 
Try to calm an animal or creature.
...
***Heal | 1 SP*** | 
A creature you can see gains 2d6+CHA HP.

***Harm | 1 SP*** | 
A creature you can see loses 2d6+CHA HP.
...
***Curse | 1 SP*** |
Try to curse a creature. Something horrible happens to them.

***Revivify | 5 SP*** | 
A character who died in the last day can be resurrected, but they take 3 Injuries from the Injury table. Your SP is permanently reduced by 1.

***Armor of Faith | 1 SP*** | 
A character you touch gains an AC of 18 for 10 minutes.

***Immolate | 1 SP*** | 
A Zone becomes engulfed in flames. Creatures in the Zone can try to escape, or take 2d6 Dmg.

***Crackle | 1 SP*** | 
A Line 30 feet long is shocked by electricity. Creatures in the line can try to escape, or take 2d6 Dmg. Creatures wearing metal automatically fail.

***Freeze | 1 SP*** | 
A single target's blood begins to freeze. They can try to escape your grasp, or take 2d6 Dmg. Either way, their speed is reduced to 0 until after their next turn.
...
***Faith*** |
    Allies in your Zone gain +CHA/3 to all checks.
...
***Retreat | 1 SP | Quick*** |
    All allies can immediately move up to their speed in order to retreat from a fight.

***Inspiring Speech | 1 SP*** | 
...
## Equipment
### Weapons
This game doesn't define weapons for use, as much as provides a guideline for which weapons are suitable at each tier of play.

***Peasant's weapons*** | d4
> Common items, used to fight. Pitchforks, sticks, torches, hammers, knives, slings, broken swords.

***Simple weapons*** | d6
> Weapons that once saw a smith, or otherwise pack a punch. Shortswords, daggers, clubs, quarterstaves, axes.

***Martial weapons*** | d8
> Weapons forged for the waging of war. Battleaxes, maces, bows, crossbows, javelins, spears, side swords, scimitars, rapiers.

***Hero's weapons*** | d10
> Weapons fit for a knight or a true specialist warrior. Longswords, mauls, halberds, lances, greatbows.
> It is fairly rare to encounter weapons not governed by STR at this tier.

***Mythical weapons*** | d12
> Pieces of art. Greatswords, poleaxes, and the like, with particularly fine craftsmanship.
...
A shield provides the modest protection of
> +2 AC

And a helm can be added to any configuration for
> +1 AC
...
1. ***Allocate your attributes.***

You choose a distribution, outlined below.
...
2. ***Choose an archetype.*** Familiarize yourself with your new abilities and skills.
...
4. ***Determine your Adventuring Gear.***

Choose a peasant's weapon if applicable. Determine where you got such a weapon.

Gather one piece of adventuring equipment, at a usual quantity.
> For instance, 30 ft. of rope, 10 rocks for use with a sling, three torches, or a tinderbox.

Add 3 days' rations.

Determine your wealth (DM will provide this).
